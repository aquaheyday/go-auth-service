...
type AuthServiceClient interface {
	SendVerification(ctx context.Context, in *SendVerificationReq, opts ...grpc.CallOption) (*SendVerificationRes, error)
...
func (c *authServiceClient) SendVerification(ctx context.Context, in *SendVerificationReq, opts ...grpc.CallOption) (*SendVerificationRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendVerificationRes)
...
type AuthServiceServer interface {
	SendVerification(context.Context, *SendVerificationReq) (*SendVerificationRes, error)
...
func (UnimplementedAuthServiceServer) SendVerification(context.Context, *SendVerificationReq) (*SendVerificationRes, error) {
...
func _AuthService_SendVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SendVerification(ctx, req.(*SendVerificationReq))
	}
